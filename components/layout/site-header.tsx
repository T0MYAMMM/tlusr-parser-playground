...
import { Github, Sparkles, Workflow, BookOpen, GitCompare, FlaskConical } from 'lucide-react';
      ...
      <div className="mx-auto flex h-14 max-w-[1440px] items-center gap-6 px-6">
        <Link href="/" className="group flex items-center gap-2">
          ...
          <span className="font-semibold tracking-tight">
            ...
            <span className="text-zinc-400"> Parser</span>
          </span>
        ...
        <div className="ml-auto flex items-center gap-2">
          <Button variant="outline" size="sm" asChild>
            <a
              href="https://github.com/t0myammm/tlusr-article-parsing-intelligence"
              target="_blank"
              rel="noreferrer"
            >
