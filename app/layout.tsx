...
export const metadata: Metadata = {
  title: { default: 'Tlusr Parser — Intelligent Article Parsing', template: '%s · Tlusr Parser' },
  description:
    'Developer playground, documentation, and pipeline visualizer for Tlusr Parser — a confidence-cascading HTML-to-Article engine.',
  metadataBase: new URL('https://tlusr.dev'),
};
  ...
  return (
    <html lang="en" className={cn('dark', sans.variable, mono.variable)} suppressHydrationWarning>
      <body className="min-h-screen font-sans">
        {/* Background ornaments — grid + radial glow. */}
        <div
          aria-hidden
        ...
        <TooltipProvider delayDuration={200}>
          <div className="flex min-h-screen flex-col">
            ...
            <footer className="border-t border-white/[0.06] py-6 text-center text-xs text-muted-foreground">
              Built with Next.js, React Flow, and the Tlusr parser package · MIT
            </footer>
          </div>
        </TooltipProvider>
      </body>
